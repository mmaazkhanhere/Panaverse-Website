            ...
            <Container maxW={1800}>
                ...
                <RevealWrapper origin='top' delay={300} duration={1000} distance='500px' reset={true}>
                    <Box bgColor='rgba(120, 91, 92)' textColor='white' borderRadius='30px' mr={{ lg: '100px', base: '30px' }} ml={{ base: '30px', lg: '100' }}>
                        <Center>
                            <Heading textAlign='center' size={{ base: '2xl', lg: '3xl' }} fontWeight='bold'>Web 3 and Metaverse Specialisation </Heading>
                        </Center>
                    </Box>
                </RevealWrapper>
                ...
                <RevealWrapper origin='top' delay={300} duration={1380} distance='500px' reset={true}>
                ...
                <RevealWrapper origin='top' delay={300} duration={1400} distance='500px' reset={true}>
                    <Heading mt='15px' bgColor='rgba(120, 91, 92)' textColor='white' borderRadius='30px' as='u' size={{ base: 'sm', lg: 'lg' }}>Course Outline</Heading>
                </RevealWrapper>
                ...
                <RevealWrapper origin='top' delay={300} duration={1440} distance='500px' reset={true}>
                ...
                <RevealWrapper origin='top' delay={300} duration={1450} distance='500px' reset={true}>
                    <Text pt='10px' fontSize={{ lg: '24px', base: '16px' }}>
                ...
                <RevealWrapper origin='top' delay={300} duration={1460} distance='500px' reset={true}>
                ...
                <RevealWrapper origin='top' delay={300} duration={1500} distance='500px' reset={true}>
                    <Heading mt='25px' bgColor='rgba(120, 91, 92)' textColor='white' borderRadius='30px' as='u' size={{ base: 'sm', lg: 'lg' }}> Blockchain Project: Create a Token and Launch ICO/IEP/IDO</Heading>
                </RevealWrapper>

                {/*Project Part: 1 */}

                <RevealWrapper origin='top' delay={300} duration={1550} distance='500px' reset={true}>
                    <Heading mt='10px' size={{ base: 'xs', lg: 'md' }}>1.  How to Launch a IEO on Binance Launchpad</Heading>
                    <Text pt='10px' fontSize={{ lg: '24px', base: '16px' }}>
