...
export default function Quarter1() {
    return (
        <>
            <Box mt={{ base: '20px', lg: '50px' }} bgColor='rgba(255, 244, 223, 1)' borderRadius={{ base: '20px', lg: '30px' }} mr={{ lg: '100px', base: '30px' }} ml={{ base: '30px', lg: '100' }} >
                <Container maxW={1800}>
